...
<?php $__env->startSection('title', 'All Processing Orders'); ?>
...
<?php $__env->startSection('search'); ?>
    <form action="<?php echo e(route('search')); ?>" method="GET">
        <div class="input-group">
            <input type="hidden" name="search_section" value="processing_orders">
...
<?php $__env->startSection('content'); ?>
    ...
    <?php echo e($processing_orders->withQueryString()->links()); ?>
...
<?php echo $__env->make('backend.layouts.parent', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\electro-commerce\E-commerce-main\E-commerce-main\resources\views/backend/orders/processingOrders.blade.php ENDPATH**/ ?>